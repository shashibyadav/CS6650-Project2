...
import com.project.two.implementation.StoreServiceImpl;
import com.project.two.interfaces.StoreService;
import com.project.two.server.ProjectEnums.ConnectionType;
import com.project.two.server.ProjectEnums.DataKeys;
import com.project.two.server.ProjectEnums.MethodType;
import com.project.two.server.ProjectEnums.RequestKeys;
...
import com.project.two.utills.ServerSocketM;
import com.project.two.utills.SocketM;
...
public class Server {
    ...
    private StoreService stubRPC = null;
    private Registry registryRPC = null;
     ...
     * @param e
     */
    private void loggerEx(Exception e) {
    ...
    public void startServer() throws IOException {
        ...
        if (this.serverRPC == null
            ...
            this.registryRPC.rebind(this.sConfig.getServiceKey().toString(), this.stubRPC);
